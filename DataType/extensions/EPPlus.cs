...
namespace SMNETCORE.DataType.Extensions
{
    ...
    /// Convert an Epplus ExcelPackage to a CSV file, returning the byte[] array of this new CSV file.
    /// Taking the code provided by "Brad" at http://codejournal.blogspot.co.uk/2012/03/using-epplus-library-to-convert-xlsx-to.html 
    /// and creating an extension method from it which can be called on Epplus' ExcelPackage. Just call excelPackageObject.ConvertToCsv();
    /// </summary>
