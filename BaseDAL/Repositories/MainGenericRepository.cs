...
namespace SMNETCORE.DAL.BaseDAL.Repositories
{
    public class MainCatalogueRepository<T> : IDisposable
        where T : DalContextBaseModel, new()
    {
        public TenantDTOModel Tenant { get; set; }
        public AuthContextDTOModel AuthContext { get; set; }
        public MainCatalogueRepository()
            : base()
        {
        }

        internal MainCatalogueDALContext InternalContext
        {
            get
            {
                return MainCatalogueContextManager.Context;
            }
        }

        public MainCatalogueDALContext NewInternalContext()
        {
            return MainCatalogueContextManager.NewContext();
        }
